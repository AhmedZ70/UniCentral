...
from .views import (
    ...
    MyProfessorsView,
    MyReviewsView,
    UserCourseReviewsAPIView,
    UserProfessorReviewsAPIView,
    EditCourseReviewView,
    EditProfessorReviewView,
    CourseReviewFormView,
    ProfessorReviewFormView,
    MyClassmatesView,
    MyAccountView,
    EditAccountView,
    UpdateReviewAPIView,
...
urlpatterns = [
    ...
    path('api/reviews/delete/', DeleteReviewAPIView.as_view(), name='delete-review'),
    ...
    path('api/courses/review/<int:review_id>/edit/', CourseReviewFormView.as_view(), name='edit-course-review'),
    path('api/professors/review/<int:review_id>/edit/', ProfessorReviewFormView.as_view(), name='edit-professor-review'),
    ...
    path('api/user/reviews/courses', UserCourseReviewsAPIView.as_view(), name='user-course-reviews'),
    path('api/user/reviews/professors', UserProfessorReviewsAPIView.as_view(), name='user-professor-reviews'),
    path('edit-course-review/<int:review_id>/', EditCourseReviewView.as_view(), name='edit-course-review'),
    path('edit-professor-review/<int:review_id>/', EditProfessorReviewView.as_view(), name='edit-professor-review'),
    path('api/reviews/delete', DeleteReviewAPIView.as_view(), name='delete-review'),

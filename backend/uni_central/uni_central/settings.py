"""
Django settings for uni_central project.
...
SECRET_KEY = "django-insecure-=jr6_k9l2*tg)agva^f^3vyh&rn&d@z3wum!k!+)li4@wr_j68"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['www.uni-central.com','uni-central.com', 'localhost', '127.0.0.1', '107.21.203.234']
...
WSGI_APPLICATION = "uni_central.wsgi.application"
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "uni_central","uni_central", "static"),  
]
